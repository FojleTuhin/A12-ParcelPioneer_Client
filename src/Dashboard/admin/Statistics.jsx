    ...
    return (
        <div>
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-14">
                <div className="h-[140px] w-[240px] md:w-[270px] bg-[#EBFBE5] flex flex-col items-center justify-center rounded-2xl">
                ...
                <div className="h-[140px] w-[240px] md:w-[270px] bg-[#FAECFF] flex flex-col items-center justify-center rounded-2xl">
