...
const BookAParcel = () => {
  ...
  const handleWeightChange = (e) => {
    const inputWeight = Number.parseFloat(e.target.value)
  ...
  return (
    <div>
      <Helmet>
        <title>ParcelPioneer || BookAParcel</title>
      </Helmet>
      <div className="px-4 md:px-8 lg:px-[100px]  pb-1 bg-[#F8F6F1] ">
        ...
        <form onSubmit={handleBookAParcel}>
            ...
            <div className="form-control w-full">
              ...
              <label className="input-group">
                <input
                  ...
                  className="border border-[rgb(226, 232, 240)] py-2 px-4 rounded-lg w-full  bg-[#f4f3f0]"
                />
              </label>
            </div>
            <div className="form-control w-full">
            ...
            <div className="form-control w-full">
              ...
              <label className="input-group">
                <input
                  ...
                  name="receiverName"
                  required
                  placeholder="Add receiver name here"
                  className="border border-[rgb(226, 232, 240)] py-2 px-4 rounded-lg w-full  bg-[#f4f3f0]"
                />
              </label>
            </div>
            <div className="form-control w-full">
              ...
              <label className="input-group">
                <input
                  ...
                  required
                  placeholder="Add receiver number here"
                  className="border border-[rgb(226, 232, 240)] py-2 px-4 rounded-lg w-full  bg-[#f4f3f0]"
                />
              </label>
            </div>
            ...
            <div className="form-control w-full">
              ...
              <label className="input-group">
                <input
                  ...
                  name="latitude"
                  required
                  placeholder="Find Latitude from google map"
                  className="border border-[rgb(226, 232, 240)] py-2 px-4 rounded-lg w-full  bg-[#f4f3f0]"
                />
              </label>
            </div>
            <div className="form-control w-full">
              ...
              <label className="input-group">
                <input
                  ...
                  name="longitude"
                  required
                  placeholder="Find Longitude from google map"
                  className="border border-[rgb(226, 232, 240)] py-2 px-4 rounded-lg w-full  bg-[#f4f3f0]"
                />
              </label>
            </div>
          ...
          <div className="md:flex mb-5 ">
            <button className=" bg-[#3EA570] border-none text-white w-1/2 justify-center m-auto py-2 rounded-lg font-bold text-xl">
              Book
            </button>
          </div>
        </form>
