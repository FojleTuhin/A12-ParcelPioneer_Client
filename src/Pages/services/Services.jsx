      ...
      <section className="bg-[#EEDDD5] py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-gray-700 max-w-3xl mx-auto text-lg">
            Discover our range of reliable delivery services designed to meet
            all your parcel delivery needs.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Let your customers choose their desired delivery time! Have it
                  delivered to you on Parcel - Fast, without any hassle.
                </p>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  You can trust us to deliver your most confidential documents
                  to the desired place absolutely intact right on time.
                </p>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-center">
                    <ArrowRight className="h-4 w-4 text-amber-500 mr-2" />
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Need to send something right now to the quickest time, because
                  your emergency wont wait? It is urgent!
                </p>
                <ul className="space-y-2 mb-4">
                  <li className="flex items-center">
                    <ArrowRight className="h-4 w-4 text-amber-500 mr-2" />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6 flex">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Specialized delivery service for online businesses with order
                  tracking, cash on delivery options, and return management.
                </p>
                <Link
                  to={"#"}
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Plan your deliveries in advance with our scheduled service,
                  perfect for regular shipments and business operations.
                </p>
                <Link
                  to={"#"}
                  className="text-amber-600 font-medium flex items-center"
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Cost-effective solutions for businesses needing to ship
                  multiple packages with volume discounts and dedicated support.
                </p>
                <Link
                  to="#"
                  className="text-amber-600 font-medium flex items-center"
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-3">
                  Extra protection for valuable items with insurance coverage
                  and special handling procedures for peace of mind.
                </p>
                <Link
                  to="#"
                  className="text-amber-600 font-medium flex items-center"
      ...
      <section className="py-16 bg-amber-50">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            Ready to Ship with ParcelPioneer?
          </h2>
          <p className="text-gray-700 max-w-2xl mx-auto mb-8">
            Experience the fastest, most reliable delivery service in Dhaka and
            Chattogram. Book your first delivery today!
          </p>
