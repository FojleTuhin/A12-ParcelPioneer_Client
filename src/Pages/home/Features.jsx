...
const Features = () => {
    return (
        <div>
            <Title heading='Our Reliable Delivery Services' subheading='Fast, Secure, and Dependable Delivery Solutions'></Title>
            <div className="flex flex-wrap justify-center gap-6 px-4 md:px-16 mt-16 md:mt-20 mb-10">
